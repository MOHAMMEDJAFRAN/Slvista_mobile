...
const FoodBeverageListing = () => {
  ...
  // Sample food & beverage data
  const foodData = [
    { id: 1, name: "Fine Dining Restaurant", category: "Restaurant" },
    { id: 2, name: "Local Coffee Shop", category: "Cafe" },
    { id: 3, name: "Cocktail Lounge", category: "Bar" },
    { id: 4, name: "Food Truck Festival", category: "Street Food" },
    { id: 5, name: "Artisan Bakery", category: "Bakery" },
    { id: 6, name: "Gelato Shop", category: "Dessert" },
    { id: 7, name: "Family Restaurant", category: "Restaurant" },
    { id: 8, name: "Tea House", category: "Cafe" },
    { id: 9, name: "Wine Bar", category: "Bar" },
    { id: 10, name: "Local Market Stalls", category: "Street Food" },
    { id: 11, name: "Pastry Shop", category: "Bakery" },
    { id: 12, name: "Chocolate Factory", category: "Dessert" }
  ];
  ...
  const handleItemPress = (item) => {
    // Navigate to details screen or show more information
    ...
    <View className="flex-1 bg-gray-50">
      ...
      <View className="p-4 bg-white border-b border-gray-200">
        <Text className="text-gray-600">
          Showing {filteredData.length} of {foodData.length} options
        ...
        {filteredData.length > 0 ? (
          filteredData.map((item) => (
            <TouchableOpacity 
              ...
              className="bg-white rounded-full p-2 mb-3 shadow-sm border border-gray-100 flex-row items-center"
            >
          ...
          <View className="bg-white rounded-xl p-8 items-center justify-center">
            ...
            <Text className="text-gray-500 text-lg mt-4 text-center">No food & beverage options match your filters</Text>
            <TouchableOpacity 
